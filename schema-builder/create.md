...
The majority of the work comes from calling methods on the `Blueprint` object. A `Blueprint` defines the [columns](columns.md) and [indexes](column-modifiers.md) for your tables.
